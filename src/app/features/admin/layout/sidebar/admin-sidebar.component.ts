...
import { NavGroup, NavItem } from './nav.model';
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'categories',
        label: 'Categorías',
        icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a2 2 0 014-4z',
...
export class AdminSidebarComponent {
  ...
  protected trackGroup(_index: number, group: NavGroup): string {
    return group.id;
  }

  protected trackItem(_index: number, item: NavItem): string {
    return item.id;
  }
}
